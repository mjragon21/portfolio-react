        ...
        >
            <div class="h-screen pt-32">
                <div class="grid grid-cols-1">
                    ...
                    <div class="relative flex flex-col items-center mt-10  shadow-sm xl:flex-row xl:mt-0">
                            ...
                            <section className="relative flex flex-wrap ">
                                ...
                                <div className="flex justify-center relative w-full lg:w-1/2">
                                    <motion.div
                                        ...
                                        className='w-full h- py-2 pl-1 bg-transparent lg:py-0 xl:rounded-r sm:pl-2 xl:pl-0'
                                    >
                                        <img
                                            className=''
                                            alt=""
